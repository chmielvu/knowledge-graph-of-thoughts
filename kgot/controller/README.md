...
For the time being, we provide control logic sets depending on the [backend type](../knowledge_graph/README.md) (Neo4j, FalkorDB, or NetworkX) and the solution technique (DR or Graph Query).
